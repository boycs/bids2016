...
public class PagerNewsCategoryHot_1 extends Fragment {
	...
	private void initSetData() {
		...
		try {
			tv_symbol.setText(""
					+ AttributeBegin.contentGetArticleByCategoryHot.getJSONObject(1)
							.get("symbol"));
			...
			if (AttributeBegin.contentGetArticleByCategoryHot.getJSONObject(1)

...
public class ListAdapterSearchSymbolSystemTradeEsu extends ArrayAdapter {
	ArrayList<CatalogGetSymbol> arl;

	public ListAdapterSearchSymbolSystemTradeEsu(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		li_row.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// ----- hide list search --------
				PagerSystemTradeEsu.hideListSearch();

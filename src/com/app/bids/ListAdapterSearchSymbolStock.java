...
public class ListAdapterSearchSymbolStock extends ArrayAdapter {
	
	ArrayList<CatalogGetSymbol> arl;
	
	public static PagerWatchList pagerWatchList;
	
	public ListAdapterSearchSymbolStock(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final String symbol = arl.get(position).symbol;
		final String market_id = arl.get(position).market_id;
		final String symbol_fullname_eng = arl.get(position).symbol_fullname_eng;
		final String symbol_fullname_thai = arl.get(position).symbol_fullname_thai;
		final String last_trade = arl.get(position).last_trade;
		final String percentChange = arl.get(position).percentChange;
		
		// text
		tv_symbol.setText(symbol);
		tv_market_id.setText(market_id);
		tv_symbol_fullname_eng.setText(symbol_fullname_eng);
		// tag
		tv_symbol.setTag(symbol);
		tv_market_id.setTag(market_id);
		tv_symbol_fullname_eng.setTag(symbol_fullname_eng);
		img_add_symbol.setTag(symbol);
		li_row.setTag(symbol);
		...
		img_add_symbol.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					FragmentChangeActivity.strSearchPortName = symbol;
					FragmentChangeActivity.selectSearchPortStock = true;
					
					FragmentChangeActivity.contentAddPortfolioAdd = new JSONObject();
					FragmentChangeActivity.contentAddPortfolioAdd.put("symbol", symbol);
					FragmentChangeActivity.contentAddPortfolioAdd.put("fullname_eng", symbol_fullname_eng);
					FragmentChangeActivity.contentAddPortfolioAdd.put("fullname_thai", symbol_fullname_thai);
					FragmentChangeActivity.contentAddPortfolioAdd.put("price", last_trade);
					FragmentChangeActivity.contentAddPortfolioAdd.put("volume", percentChange);
...
//				FragmentChangeActivity.strSymbolSelect = symbol;

...
public class FollowProfile extends Activity {

	public static String user_id, user_id_following;
	...
	public static void sendFollow(String userid, String useridfollowing) {
	...
	public static class setFollow extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			String url = SplashScreen.url_bidschart+"/service/followByUserId";
			...
			try {
				...
				jsonObject.accumulate("user_id_following", user_id_following);

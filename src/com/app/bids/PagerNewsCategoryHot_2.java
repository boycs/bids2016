...
public class PagerNewsCategoryHot_2 extends Fragment {
	...
	private void initSetData() {
		...
		try {
			tv_symbol.setText(""
					+ AttributeBegin.contentGetArticleByCategoryHot.getJSONObject(2)
							.get("symbol"));
			...
			try {
				...
				String strDateYmd = ""
						+ (AttributeBegin.contentGetArticleByCategoryHot
								.getJSONObject(0).get("created_at").toString()).split(" ")[0];
			...
			if (AttributeBegin.contentGetArticleByCategoryHot.getJSONObject(2)

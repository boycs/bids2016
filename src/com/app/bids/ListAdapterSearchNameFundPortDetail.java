...
public class ListAdapterSearchNameFundPortDetail extends ArrayAdapter {
	ArrayList<CatalogGetNameFund> arl;
	
	public static PagerWatchList pagerWatchList;

	public ListAdapterSearchNameFundPortDetail(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		img_add_symbol.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					PagerSmartPortfolioListDetail.hideListSearch();

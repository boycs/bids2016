...
public class ListAdapterSearchSymbolSystemTradeBreakOut extends ArrayAdapter {
	ArrayList<CatalogGetSymbol> arl;

	public ListAdapterSearchSymbolSystemTradeBreakOut(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		li_row.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// ----- hide list search --------
				PagerSystemTradeBreakOut.hideListSearch();
...
//					result = "Did not work!";
//
//				Log.v("result Edit Watchlist : ", "" + result);
//
//			} catch (IOException e) {
//				connectionError = true;
//				e.printStackTrace();

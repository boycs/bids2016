...
public class CommentLikeArticle extends Activity {

	public static String article_id, user_id, content, chart_url = "",
	...
	public static void sendLikeArticle(String articleid, String userid) {

		article_id = articleid;
		user_id = userid;

		setLikeArticle resp = new setLikeArticle();
		resp.execute();
	}

	public static class setLikeArticle extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			String url = SplashScreen.url_bidschart + "/service/likeArticle";
			...
			try {
				...
				jsonObject.accumulate("article_id", article_id);
	...
	// ============== send Post Comment =========================
	public static void sendArticleComment(String postid, String userid,
			String contents) {
	...
	public static class setComment extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			super.onPostExecute(result);
				UiWatchlistDetailNewsSelectComments.initGetArticleComment();
		}
	}

	// ============== send Like Post =========================
	public static void sendArticleLike(String commentsid, String userid,
			Boolean ck) {
	...
	public static class setAgree extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			String url = "";
			if (ckLikePost) {
				url = SplashScreen.url_bidschart
						+ "/service/agreeCommentArticle";
			} else {
				url = SplashScreen.url_bidschart
						+ "/service/disagreeCommentArticle";
			}
	...
	public static class setAgreeReply extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			String url = "";
			if (ckLikeReply) {
				url = SplashScreen.url_bidschart + "/service/agreeReplyArticle";
			} else {
				url = SplashScreen.url_bidschart
						+ "/service/disagreeReplyArticle";
			}
	...
	// ============== send remove comment =========================
	public static void sendArticleRemoveComment(String commentsid) {

		comments_id = commentsid;

		setDelete resp = new setDelete();
		resp.execute();
	}

	public static class setDelete extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			String url = "http://service.bidschart.com/comment/removeCommentArticle";

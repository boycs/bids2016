...
public class FacebookLoginActivity2 extends Activity {
...
//	private TextView greeting;
	...
	public static void callFacebookLogout(Context context) {
		...
		FragmentChangeActivity.handlerSetProfile.sendEmptyMessage(0);
	}
...
//
//						FragmentChangeActivity.user = user;
//						updateUI();
//						handlePendingAction();
//					}
//				});
...
//		greeting = (TextView) findViewById(R.id.greeting);
	...
	private void onSessionStateChange(Session session, SessionState state,
		...
		if (pendingAction != PendingAction.NONE
			...
			new AlertDialog.Builder(FacebookLoginActivity2.this)
...
//			profilePictureView
//					.setProfileId(FragmentChangeActivity.graphUser.getId());
//			greeting.setText(getString(R.string.hello_user,
//					FragmentChangeActivity.graphUser.getFirstName()));
	...
	public class loginByFacebook extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				// {"status":"ok","message":"Get data Success.","dataAll":{"user_id":59,"username":"??????? ???????",
				// "first_name":"b-boy_sci_ubu","email":"b-boy_sci_ubu@hotmail.com","user_type":"free","followers":0,"following":0,
...
//				FragmentChangeActivity.handlerSetUser
//						.sendEmptyMessage(FragmentChangeActivity.loginStateT);

				FragmentChangeActivity.handlerSetProfile.sendEmptyMessage(1); // loign success
				finish();
			}
		}
	}
